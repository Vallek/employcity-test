...
const PATHS_TO_STATIC = [
  ...
  `${PATH_TO_SOURCE}favicons/**/*.{png,svg,webmanifest}`,
...
export function processStyles () {
  return src(`${PATH_TO_SOURCE}css/*.scss`, { sourcemaps: isDevelopment })
    .pipe(plumber())
...
export function startServer () {
  ...
  watch(`${PATH_TO_SOURCE}css/**/*.scss`, series(processStyles));
